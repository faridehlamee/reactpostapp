        ...
        <section className="page-section" id="services">
            <div className="container">
                <div className="text-center">
                    <h2 className={styles['section-heading'] + ' ' + styles['text-uppercase']}>Services</h2>
                    <h3 className={styles['section-subheading'] + ' ' +styles['text-muted']}>Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
